...
\begin{document}
	...
	Kao takvog ovaj skup podataka mo\v zemo koristiti kao dobar pokazatelj da li su do sada diskutovani metodi uop\v ste primenljivi nad stvarnim podacima i kako se nose sa njima.
	...
	\begin{table}[h!]
		...
		\begin{tabular}{|c|c|c|c|}
			...
			\hline
			\textbf{AE} & 0 & 0 & 0\\
			\textbf{KFN\_MSE} & 0 & 0 & 0\\
			\textbf{KFN\_CE} & 0 & 0 & 0\\
			\textbf{KFN\_MID} & 0 & 0 & 0\\
			\textbf{KFN\_CE\_MSE\_SUM} & 0 & 0 & 0\\
			\textbf{KFN\_CE\_MSE\_AVG} & 0 & 0 & 0\\
			\textbf{KFN\_MID\_MSE\_SUM} & 0 & 0 & 0\\
			\textbf{KFN\_MID\_MSE\_AVG} & 0 & 0 & 0\\
			\hline
		\end{tabular}
